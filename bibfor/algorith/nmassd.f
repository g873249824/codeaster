...
C
      INTEGER      IFM,NIV
      INTEGER      NBCOEF,I,NBVEC ,NEQ 
      PARAMETER   (NBCOEF=4)
      REAL*8       COEF(NBCOEF)
      CHARACTER*19 VECT(NBCOEF)
      CHARACTER*19 VEBEST(2)
      CHARACTER*19 CNBEST(2),CNDIDO,CNDIDI,CNDIPI,K19BLA
...
C
      K19BLA = ' '
      VEBEST(1) = '&&NMASSD.VEEST1'
      VEBEST(2) = '&&NMASSD.VEEST2'  
...
C
     ...
     &            DEPEST,K19BLA,K19BLA,VEBEST(1))
      CALL NMADIR(NUMEDD,FONACT,DEFICO,VEASSE,VEBEST(1),
     &            CNBEST(1))
C
C --- CONDITIONS DE DIRICHLET B.U
C
      CALL NMBUDI(MODELE,NUMEDD,LISCHA,DEPEST,VEBEST(2),
     &            CNBEST(2))
C
...
C --- NETTOYAGE
C
      CALL DETRSD('VECT_ELEM',VEBEST(1))
      CALL DETRSD('VECT_ELEM',VEBEST(2))
