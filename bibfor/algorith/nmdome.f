...
C       X-FEM INTERDIT AVEC MECA_STATIQUE
        CALL JEEXIN(MODELE(1:8)//'.XFEM_CONT',IRET)        
        IF (IRET.GT.0 .AND. NOMCMD.EQ.'MECA_STATIQUE') 
     &    CALL U2MESK('F','CALCULEL3_56',1,MODELE(1:8))
