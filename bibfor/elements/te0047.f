...
C MODIF ELEMENTS  DATE 22/05/2012   AUTEUR MACOCCO K.MACOCCO 
C ======================================================================
...
C ----------------------------------------------------------------------
      ...
      REAL*8      DDOT,DULY,FOR2,FOR3,PLOUF,VARIP
      REAL*8      ZERO,MOINS1
...
C     ZK16(ICOMPO+3)    COMP_ELAS   COMP_INCR
      IF (ZK16(ICOMPO+2)(1:5).NE.'PETIT') CALL U2MESS('A','DISCRETS_18')
