...
C
      ...
      PARAMETER (NBRES=2)
      CHARACTER*8 MODELI,ELREFE,TYPMOD(2)
      CHARACTER*4 FAMI
      ...
      INTEGER NBSIGM,IINSTM,IINSTP,IRET,COIRET,JCRET,JTAB(7),LGPG
...
C	       
     ...
     &              EPS2D,DEPS2D,
     &              SIGM,ZR(IVARIM+LGPG*(IPG-1)),
     &              OPTION,
     &              ANGMAS,
     &              LC,
     &              SIMP,
     &              ZR(IVARIP+LGPG*(IPG-1)),DSIDEP,COIRET)
             G = D(1)/(2.D0*(1.D0+D(2)))
