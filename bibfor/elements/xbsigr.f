...
C       BOUCLE SUR LES SIG TESTS : SIGTMP = {0 0 0  SIGMA 0 0 0 0 0}
        DO 200 I=1,NBSIG*NPG
          ...
          IF (NDIM .EQ. 3) THEN
            CALL XBSIG3(ELREFP,NDIM,COORSE,IGEOM,
     &                  HE,NFH,DDLC,NFE,BASLOC,NNOP,NPG,SIGTMP,
     &                  K16BID,IBID,LSN,LST,NFISS,FISNO,BSIGMA)
          ELSE
            CALL XBSIG2(ELREFP,ELRESE(NDIM+IRESE),NDIM,COORSE,IGEOM,
     &                  HE,NFH,DDLC,DDLM,NFE,
     &                  BASLOC,NNOP,NPG,SIGTMP,K16BID,IBID,
     &                  LSN,LST,NFISS,FISNO,IVECTU)
          ENDIF
