...
C MODIF ELEMENTS  DATE 14/11/2012   AUTEUR LADIER A.LADIER 
C ======================================================================
...
C       ET DE DFDI : DERIVVES DES FF PARENT
     ...
     &    NNOP,IGEOM,JBASEC,XG,JAC,FF,R27BID,DFDI,ND,R3BID,R3BID)
        ELSEIF (NDIM.EQ.2) THEN
          CALL XJACF2(ELREF,ELREFC,ELC,NDIM,FPG,JPTINT,IFA,CFACE,NDIM,
     &    IPGF,NNOP,IGEOM,JBASEC,XG,JAC,FF,R27BID,DFDI,ND,R3BID)
        ENDIF
